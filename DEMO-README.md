...
**EXPECTED OUTCOME:**
You will systematically explore this TourGuide project, understanding:
...
This guide uses TourGuide to explain TourGuide itself. The AI will navigate through this project using the same system it's learning about.
